...
function generateTable(container, initialHotels) {
	var constants = {
        ...
        HOTEL_FILTER_CLASS: 'hotel-filter',
	...
	function addButtons() {
        ...
        var hotelAddFilter = $('<button/>', {
            'class': constants.HOTEL_FILTER_CLASS,
            'text': 'Filter'
        });

        container.append(hotelAddFilter);
	}
	...
	function initEvents() {
        ...
        container.on('click', constants.HOTEL_FILTER_CLASS.toClassFormat(), function () {
            onHotelFilter(this);
        });
    }
	...
	function onHotelFilter(sender) {
	    console.log('onHotelFilter');
	    enterFilterMode();
	}
